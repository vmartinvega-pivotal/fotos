...
do
        ...
        do
                ...
                do
						...
						ls -1 -d "$PHOTOS_PATH/$YEAR/$MONTH/$FOLDER"/* | grep -E '.mp4|.MP4' > "$PHOTOS_PATH/$YEAR/$MONTH/$FOLDER/list"
						sed 's/^.*$/"&"/g' "$PHOTOS_PATH/$YEAR/$MONTH/$FOLDER/list" > "$PHOTOS_PATH/$YEAR/$MONTH/$FOLDER/list_mp4"
